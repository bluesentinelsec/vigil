...
typedef enum basl_opcode {
    ...
    BASL_OPCODE_NOT = 25,
    BASL_OPCODE_EQUAL = 26,
    BASL_OPCODE_GREATER = 27,
    BASL_OPCODE_LESS = 28,
    BASL_OPCODE_CALL = 29,
    BASL_OPCODE_NEW_INSTANCE = 30,
    BASL_OPCODE_GET_FIELD = 31,
    BASL_OPCODE_SET_FIELD = 32,
    BASL_OPCODE_CALL_INTERFACE = 33,
    BASL_OPCODE_DEFER_CALL = 34,
    BASL_OPCODE_DEFER_NEW_INSTANCE = 35,
    BASL_OPCODE_DEFER_CALL_INTERFACE = 36
} basl_opcode_t;
