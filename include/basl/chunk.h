...
typedef enum basl_opcode {
    ...
    BASL_OPCODE_POP = 5,
    BASL_OPCODE_GET_LOCAL = 6,
    BASL_OPCODE_SET_LOCAL = 7,
    BASL_OPCODE_GET_GLOBAL = 8,
    BASL_OPCODE_SET_GLOBAL = 9,
    BASL_OPCODE_JUMP = 10,
    BASL_OPCODE_JUMP_IF_FALSE = 11,
    BASL_OPCODE_LOOP = 12,
    BASL_OPCODE_ADD = 13,
    BASL_OPCODE_SUBTRACT = 14,
    BASL_OPCODE_MULTIPLY = 15,
    BASL_OPCODE_DIVIDE = 16,
    BASL_OPCODE_MODULO = 17,
    BASL_OPCODE_NEGATE = 18,
    BASL_OPCODE_NOT = 19,
    BASL_OPCODE_EQUAL = 20,
    BASL_OPCODE_GREATER = 21,
    BASL_OPCODE_LESS = 22,
    BASL_OPCODE_CALL = 23,
    BASL_OPCODE_NEW_INSTANCE = 24,
    BASL_OPCODE_GET_FIELD = 25,
    BASL_OPCODE_SET_FIELD = 26,
    BASL_OPCODE_CALL_INTERFACE = 27
} basl_opcode_t;
