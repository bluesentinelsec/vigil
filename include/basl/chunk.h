...
typedef enum basl_opcode {
    ...
    BASL_OPCODE_NEW_ERROR = 34,
    BASL_OPCODE_GET_ERROR_KIND = 35,
    BASL_OPCODE_GET_ERROR_MESSAGE = 36,
    BASL_OPCODE_EQUAL = 37,
    BASL_OPCODE_GREATER = 38,
    BASL_OPCODE_LESS = 39,
    BASL_OPCODE_CALL = 40,
    BASL_OPCODE_CALL_VALUE = 41,
    BASL_OPCODE_NEW_INSTANCE = 42,
    BASL_OPCODE_GET_FIELD = 43,
    BASL_OPCODE_SET_FIELD = 44,
    BASL_OPCODE_NEW_ARRAY = 45,
    BASL_OPCODE_NEW_MAP = 46,
    BASL_OPCODE_GET_INDEX = 47,
    BASL_OPCODE_SET_INDEX = 48,
    BASL_OPCODE_GET_COLLECTION_SIZE = 49,
    BASL_OPCODE_GET_MAP_KEY_AT = 50,
    BASL_OPCODE_GET_MAP_VALUE_AT = 51,
    BASL_OPCODE_CALL_INTERFACE = 52,
    BASL_OPCODE_DEFER_CALL = 53,
    BASL_OPCODE_DEFER_CALL_VALUE = 54,
    BASL_OPCODE_DEFER_NEW_INSTANCE = 55,
    BASL_OPCODE_DEFER_CALL_INTERFACE = 56
} basl_opcode_t;
