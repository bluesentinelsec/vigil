...
typedef enum basl_opcode {
    ...
    BASL_OPCODE_JUMP = 8,
    BASL_OPCODE_JUMP_IF_FALSE = 9,
    BASL_OPCODE_LOOP = 10,
    BASL_OPCODE_ADD = 11,
    BASL_OPCODE_SUBTRACT = 12,
    BASL_OPCODE_MULTIPLY = 13,
    BASL_OPCODE_DIVIDE = 14,
    BASL_OPCODE_MODULO = 15,
    BASL_OPCODE_NEGATE = 16,
    BASL_OPCODE_NOT = 17,
    BASL_OPCODE_EQUAL = 18,
    BASL_OPCODE_GREATER = 19,
    BASL_OPCODE_LESS = 20,
    BASL_OPCODE_CALL = 21,
    BASL_OPCODE_NEW_INSTANCE = 22,
    BASL_OPCODE_GET_FIELD = 23,
    BASL_OPCODE_SET_FIELD = 24,
    BASL_OPCODE_CALL_INTERFACE = 25
} basl_opcode_t;
