...
typedef enum basl_opcode {
    ...
    BASL_OPCODE_EQUAL = 30,
    BASL_OPCODE_GREATER = 31,
    BASL_OPCODE_LESS = 32,
    BASL_OPCODE_CALL = 33,
    BASL_OPCODE_NEW_INSTANCE = 34,
    BASL_OPCODE_GET_FIELD = 35,
    BASL_OPCODE_SET_FIELD = 36,
    BASL_OPCODE_CALL_INTERFACE = 37,
    BASL_OPCODE_DEFER_CALL = 38,
    BASL_OPCODE_DEFER_NEW_INSTANCE = 39,
    BASL_OPCODE_DEFER_CALL_INTERFACE = 40
} basl_opcode_t;
