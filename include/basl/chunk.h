...
typedef enum basl_opcode {
    ...
    BASL_OPCODE_NEW_ARRAY = 40,
    BASL_OPCODE_NEW_MAP = 41,
    BASL_OPCODE_GET_INDEX = 42,
    BASL_OPCODE_SET_INDEX = 43,
    BASL_OPCODE_GET_COLLECTION_SIZE = 44,
    BASL_OPCODE_GET_MAP_KEY_AT = 45,
    BASL_OPCODE_GET_MAP_VALUE_AT = 46,
    BASL_OPCODE_CALL_INTERFACE = 47,
    BASL_OPCODE_DEFER_CALL = 48,
    BASL_OPCODE_DEFER_NEW_INSTANCE = 49,
    BASL_OPCODE_DEFER_CALL_INTERFACE = 50
} basl_opcode_t;
