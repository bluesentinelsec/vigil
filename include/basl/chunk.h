...
typedef enum basl_opcode {
    ...
    BASL_OPCODE_TO_F64 = 32,
    BASL_OPCODE_TO_STRING = 33,
    BASL_OPCODE_FORMAT_F64 = 34,
    BASL_OPCODE_NEW_ERROR = 35,
    BASL_OPCODE_GET_ERROR_KIND = 36,
    BASL_OPCODE_GET_ERROR_MESSAGE = 37,
    BASL_OPCODE_EQUAL = 38,
    BASL_OPCODE_GREATER = 39,
    BASL_OPCODE_LESS = 40,
    BASL_OPCODE_CALL = 41,
    BASL_OPCODE_CALL_VALUE = 42,
    BASL_OPCODE_NEW_INSTANCE = 43,
    BASL_OPCODE_GET_FIELD = 44,
    BASL_OPCODE_SET_FIELD = 45,
    BASL_OPCODE_NEW_ARRAY = 46,
    BASL_OPCODE_NEW_MAP = 47,
    BASL_OPCODE_GET_INDEX = 48,
    BASL_OPCODE_SET_INDEX = 49,
    BASL_OPCODE_GET_COLLECTION_SIZE = 50,
    BASL_OPCODE_GET_MAP_KEY_AT = 51,
    BASL_OPCODE_GET_MAP_VALUE_AT = 52,
    BASL_OPCODE_CALL_INTERFACE = 53,
    BASL_OPCODE_DEFER_CALL = 54,
    BASL_OPCODE_DEFER_CALL_VALUE = 55,
    BASL_OPCODE_DEFER_NEW_INSTANCE = 56,
    BASL_OPCODE_DEFER_CALL_INTERFACE = 57
} basl_opcode_t;
