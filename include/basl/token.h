...
typedef enum basl_token_kind {
    ...
    BASL_TOKEN_GUARD = 23,
    BASL_TOKEN_CASE = 24,
    BASL_TOKEN_DEFAULT = 25,
    BASL_TOKEN_BREAK = 26,
    BASL_TOKEN_CONTINUE = 27,
    BASL_TOKEN_NIL = 28,
    BASL_TOKEN_TRUE = 29,
    BASL_TOKEN_FALSE = 30,
    BASL_TOKEN_LPAREN = 31,
    BASL_TOKEN_RPAREN = 32,
    BASL_TOKEN_LBRACE = 33,
    BASL_TOKEN_RBRACE = 34,
    BASL_TOKEN_LBRACKET = 35,
    BASL_TOKEN_RBRACKET = 36,
    BASL_TOKEN_COMMA = 37,
    BASL_TOKEN_DOT = 38,
    BASL_TOKEN_SEMICOLON = 39,
    BASL_TOKEN_COLON = 40,
    BASL_TOKEN_QUESTION = 41,
    BASL_TOKEN_ARROW = 42,
    BASL_TOKEN_ASSIGN = 43,
    BASL_TOKEN_PLUS = 44,
    BASL_TOKEN_MINUS = 45,
    BASL_TOKEN_STAR = 46,
    BASL_TOKEN_SLASH = 47,
    BASL_TOKEN_PERCENT = 48,
    BASL_TOKEN_PLUS_PLUS = 49,
    BASL_TOKEN_MINUS_MINUS = 50,
    BASL_TOKEN_PLUS_ASSIGN = 51,
    BASL_TOKEN_MINUS_ASSIGN = 52,
    BASL_TOKEN_STAR_ASSIGN = 53,
    BASL_TOKEN_SLASH_ASSIGN = 54,
    BASL_TOKEN_PERCENT_ASSIGN = 55,
    BASL_TOKEN_EQUAL_EQUAL = 56,
    BASL_TOKEN_BANG = 57,
    BASL_TOKEN_BANG_EQUAL = 58,
    BASL_TOKEN_LESS = 59,
    BASL_TOKEN_LESS_EQUAL = 60,
    BASL_TOKEN_GREATER = 61,
    BASL_TOKEN_GREATER_EQUAL = 62,
    BASL_TOKEN_AMPERSAND = 63,
    BASL_TOKEN_AMPERSAND_AMPERSAND = 64,
    BASL_TOKEN_PIPE = 65,
    BASL_TOKEN_PIPE_PIPE = 66,
    BASL_TOKEN_CARET = 67,
    BASL_TOKEN_TILDE = 68,
    BASL_TOKEN_SHIFT_LEFT = 69,
    BASL_TOKEN_SHIFT_RIGHT = 70
} basl_token_kind_t;
