...
typedef enum basl_token_kind {
    ...
    BASL_TOKEN_FOR = 19,
    BASL_TOKEN_WHILE = 20,
    BASL_TOKEN_SWITCH = 21,
    BASL_TOKEN_CASE = 22,
    BASL_TOKEN_DEFAULT = 23,
    BASL_TOKEN_BREAK = 24,
    BASL_TOKEN_CONTINUE = 25,
    BASL_TOKEN_NIL = 26,
    BASL_TOKEN_TRUE = 27,
    BASL_TOKEN_FALSE = 28,
    BASL_TOKEN_LPAREN = 29,
    BASL_TOKEN_RPAREN = 30,
    BASL_TOKEN_LBRACE = 31,
    BASL_TOKEN_RBRACE = 32,
    BASL_TOKEN_LBRACKET = 33,
    BASL_TOKEN_RBRACKET = 34,
    BASL_TOKEN_COMMA = 35,
    BASL_TOKEN_DOT = 36,
    BASL_TOKEN_SEMICOLON = 37,
    BASL_TOKEN_COLON = 38,
    BASL_TOKEN_QUESTION = 39,
    BASL_TOKEN_ARROW = 40,
    BASL_TOKEN_ASSIGN = 41,
    BASL_TOKEN_PLUS = 42,
    BASL_TOKEN_MINUS = 43,
    BASL_TOKEN_STAR = 44,
    BASL_TOKEN_SLASH = 45,
    BASL_TOKEN_PERCENT = 46,
    BASL_TOKEN_PLUS_PLUS = 47,
    BASL_TOKEN_MINUS_MINUS = 48,
    BASL_TOKEN_PLUS_ASSIGN = 49,
    BASL_TOKEN_MINUS_ASSIGN = 50,
    BASL_TOKEN_STAR_ASSIGN = 51,
    BASL_TOKEN_SLASH_ASSIGN = 52,
    BASL_TOKEN_PERCENT_ASSIGN = 53,
    BASL_TOKEN_EQUAL_EQUAL = 54,
    BASL_TOKEN_BANG = 55,
    BASL_TOKEN_BANG_EQUAL = 56,
    BASL_TOKEN_LESS = 57,
    BASL_TOKEN_LESS_EQUAL = 58,
    BASL_TOKEN_GREATER = 59,
    BASL_TOKEN_GREATER_EQUAL = 60,
    BASL_TOKEN_AMPERSAND = 61,
    BASL_TOKEN_AMPERSAND_AMPERSAND = 62,
    BASL_TOKEN_PIPE = 63,
    BASL_TOKEN_PIPE_PIPE = 64,
    BASL_TOKEN_CARET = 65,
    BASL_TOKEN_TILDE = 66,
    BASL_TOKEN_SHIFT_LEFT = 67,
    BASL_TOKEN_SHIFT_RIGHT = 68
} basl_token_kind_t;
