 ...
 */
typedef vigil_debug_action_t (*vigil_debug_callback_t)(
...
VIGIL_API vigil_status_t vigil_debugger_create(
...
VIGIL_API void vigil_debugger_set_callback(
    vigil_debugger_t *debugger,
...
VIGIL_API vigil_status_t vigil_debugger_set_breakpoint(
    vigil_debugger_t *debugger,
 ...
 */
VIGIL_API vigil_status_t vigil_debugger_set_breakpoint_function(
    vigil_debugger_t *debugger,
...
VIGIL_API vigil_status_t vigil_debugger_clear_breakpoint(
    vigil_debugger_t *debugger,
    size_t breakpoint_id
);
VIGIL_API void vigil_debugger_clear_all_breakpoints(
    vigil_debugger_t *debugger
);
 ...
 */
VIGIL_API void vigil_debugger_set_symbols(
    vigil_debugger_t *debugger,
...
VIGIL_API vigil_status_t vigil_debugger_current_location(
...
VIGIL_API size_t vigil_debugger_frame_count(
    const vigil_debugger_t *debugger
);

/** Get info about a call frame (0 = innermost). */
VIGIL_API vigil_status_t vigil_debugger_frame_info(
    const vigil_debugger_t *debugger,
    size_t frame_index,
 ...
 */
VIGIL_API size_t vigil_debugger_frame_locals(
    const vigil_debugger_t *debugger,
    size_t frame_index,
 ...
 */
VIGIL_API vigil_status_t vigil_debugger_get_local(
    const vigil_debugger_t *debugger,
    size_t frame_index,
    const char *name,
