...
VIGIL_API void vigil_cli_init(
    vigil_cli_t *cli,
    const char *program_name,
    const char *description
);

VIGIL_API void vigil_cli_init_with_allocator(
    vigil_cli_t *cli,
    const char *program_name,
    const char *description,
...
VIGIL_API vigil_cli_command_t *vigil_cli_add_command(
    vigil_cli_t *cli,
    const char *name,
    const char *help
);
...
VIGIL_API const vigil_cli_command_t *vigil_cli_matched_command(
    const vigil_cli_t *cli
);

/* ── Flags (on a command, or globally on the cli) ────────────────── */

VIGIL_API void vigil_cli_add_string_flag(
...
VIGIL_API void vigil_cli_add_bool_flag(
    vigil_cli_command_t *command,
    const char *name,
    char short_name,
    const char *help,
...
VIGIL_API void vigil_cli_add_global_string_flag(
    vigil_cli_t *cli,
    const char *name,
    char short_name,
    const char *help,
...
VIGIL_API void vigil_cli_add_global_bool_flag(
    vigil_cli_t *cli,
    const char *name,
    char short_name,
    const char *help,
...
VIGIL_API void vigil_cli_add_positional(
    vigil_cli_command_t *command,
    const char *name,
    const char *help,
    const char **out_value
...
VIGIL_API void vigil_cli_add_global_positional(
    vigil_cli_t *cli,
    const char *name,
    const char *help,
    const char **out_value
 ...
 */
VIGIL_API vigil_status_t vigil_cli_parse(
    vigil_cli_t *cli,
    int argc,
    char **argv,
    vigil_error_t *error
...
VIGIL_API void vigil_cli_print_command_help(
    const vigil_cli_t *cli,
    const vigil_cli_command_t *command
);
