 ...
 */
VIGIL_API vigil_status_t vigil_json_null_new(
    const vigil_allocator_t *allocator,
    vigil_json_value_t **out,
    vigil_error_t *error
);

VIGIL_API vigil_status_t vigil_json_bool_new(
    const vigil_allocator_t *allocator,
    int value,
    vigil_json_value_t **out,
    vigil_error_t *error
...
VIGIL_API vigil_status_t vigil_json_number_new(
    const vigil_allocator_t *allocator,
    double value,
    vigil_json_value_t **out,
    vigil_error_t *error
...
VIGIL_API vigil_status_t vigil_json_string_new(
    const vigil_allocator_t *allocator,
    const char *value,
    size_t length,
    vigil_json_value_t **out,
...
VIGIL_API vigil_status_t vigil_json_array_new(
    const vigil_allocator_t *allocator,
    vigil_json_value_t **out,
    vigil_error_t *error
);

VIGIL_API vigil_status_t vigil_json_object_new(
    const vigil_allocator_t *allocator,
    vigil_json_value_t **out,
    vigil_error_t *error
);
...
VIGIL_API const vigil_json_value_t *vigil_json_array_get(
    const vigil_json_value_t *array,
    size_t index
);

/* Takes ownership of element. */
VIGIL_API vigil_status_t vigil_json_array_push(
...
VIGIL_API const vigil_json_value_t *vigil_json_object_get(
    const vigil_json_value_t *object,
    const char *key
);

/* Takes ownership of value.  Replaces existing key if present. */
VIGIL_API vigil_status_t vigil_json_object_set(
...
VIGIL_API vigil_status_t vigil_json_object_entry(
    const vigil_json_value_t *object,
    size_t index,
    const char **out_key,
...
VIGIL_API vigil_status_t vigil_json_parse(
    const vigil_allocator_t *allocator,
    const char *input,
    size_t length,
    vigil_json_value_t **out,
 ...
 */
VIGIL_API vigil_status_t vigil_json_emit(
