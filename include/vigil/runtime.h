...
VIGIL_API vigil_status_t vigil_runtime_open(
    vigil_runtime_t **out_runtime,
    const vigil_runtime_options_t *options,
    vigil_error_t *error
);
...
VIGIL_API vigil_status_t vigil_runtime_set_logger(
    vigil_runtime_t *runtime,
    const vigil_logger_t *logger,
    vigil_error_t *error
);
/* vigil_runtime_alloc zero-initializes the returned memory on success. */
VIGIL_API vigil_status_t vigil_runtime_alloc(
    vigil_runtime_t *runtime,
    size_t size,
    void **out_memory,
    vigil_error_t *error
 ...
 */
VIGIL_API vigil_status_t vigil_runtime_realloc(
    vigil_runtime_t *runtime,
    void **memory,
    size_t size,
    vigil_error_t *error
