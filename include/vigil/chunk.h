 ...
 */
VIGIL_API const vigil_value_t *vigil_chunk_constant(
    const vigil_chunk_t *chunk,
    size_t index
);
VIGIL_API vigil_source_span_t vigil_chunk_span_at(
    const vigil_chunk_t *chunk,
    size_t offset
);
VIGIL_API const char *vigil_opcode_name(vigil_opcode_t opcode);
VIGIL_API vigil_status_t vigil_chunk_write_byte(
    vigil_chunk_t *chunk,
    uint8_t value,
    vigil_source_span_t span,
    vigil_error_t *error
);
VIGIL_API vigil_status_t vigil_chunk_write_opcode(
    vigil_chunk_t *chunk,
    vigil_opcode_t opcode,
    vigil_source_span_t span,
    vigil_error_t *error
);
VIGIL_API vigil_status_t vigil_chunk_write_u32(
    vigil_chunk_t *chunk,
    uint32_t value,
    vigil_source_span_t span,
    vigil_error_t *error
);
VIGIL_API vigil_status_t vigil_chunk_add_constant(
    vigil_chunk_t *chunk,
    const vigil_value_t *value,
    size_t *out_index,
    vigil_error_t *error
);
VIGIL_API vigil_status_t vigil_chunk_write_constant(
    vigil_chunk_t *chunk,
    const vigil_value_t *value,
    vigil_source_span_t span,
    size_t *out_index,
...
VIGIL_API vigil_status_t vigil_chunk_disassemble(
    const vigil_chunk_t *chunk,
