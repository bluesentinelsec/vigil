...
VIGIL_API vigil_status_t vigil_semantic_file_create(
 ...
 */
VIGIL_API const vigil_semantic_node_t *vigil_semantic_file_node_at(
 ...
 */
VIGIL_API vigil_semantic_type_t vigil_semantic_file_type_at(
    const vigil_semantic_file_t *file,
    size_t offset
);
 ...
 */
VIGIL_API vigil_status_t vigil_semantic_file_visible_symbols(
    const vigil_semantic_file_t *file,
    size_t offset,
...
VIGIL_API vigil_status_t vigil_semantic_index_create(
 ...
 */
VIGIL_API vigil_status_t vigil_semantic_index_analyze(
 ...
 */
VIGIL_API void vigil_semantic_index_remove(
    vigil_semantic_index_t *index,
    vigil_source_id_t source_id
);
 ...
 */
VIGIL_API const vigil_semantic_file_t *vigil_semantic_index_get_file(
 ...
 */
VIGIL_API vigil_status_t vigil_semantic_index_definition_at(
    const vigil_semantic_index_t *index,
    vigil_source_id_t source_id,
    size_t offset,
 ...
 */
VIGIL_API vigil_status_t vigil_semantic_index_references_at(
    const vigil_semantic_index_t *index,
    vigil_source_id_t source_id,
    size_t offset,
...
VIGIL_API int vigil_semantic_type_equal(
    vigil_semantic_type_t left,
    vigil_semantic_type_t right
);
 ...
 */
VIGIL_API char *vigil_semantic_type_to_string(
    const vigil_semantic_index_t *index,
    vigil_semantic_type_t type
);
