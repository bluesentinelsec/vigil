...
VIGIL_API void vigil_byte_buffer_init(
...
VIGIL_API vigil_status_t vigil_byte_buffer_reserve(
    vigil_byte_buffer_t *buffer,
    size_t capacity,
    vigil_error_t *error
);
VIGIL_API vigil_status_t vigil_byte_buffer_resize(
    vigil_byte_buffer_t *buffer,
    size_t length,
    vigil_error_t *error
);
VIGIL_API vigil_status_t vigil_byte_buffer_append(
    vigil_byte_buffer_t *buffer,
    const void *data,
    size_t length,
    vigil_error_t *error
);
VIGIL_API vigil_status_t vigil_byte_buffer_append_byte(
    vigil_byte_buffer_t *buffer,
    uint8_t value,
    vigil_error_t *error
);
