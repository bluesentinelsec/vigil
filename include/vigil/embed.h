...
extern "C"
{
     ...
     */
    VIGIL_API vigil_status_t vigil_embed_single(const char *file_path, char **out_text, size_t *out_length,
                                                vigil_error_t *error);
     ...
     * Caller must free *out_text.
     */
    VIGIL_API vigil_status_t vigil_embed_multi(const char **file_paths, const char **rel_paths, size_t file_count,
