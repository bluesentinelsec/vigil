...
extern "C"
{
    ...
    VIGIL_API void vigil_token_list_init(vigil_token_list_t *list, vigil_runtime_t *runtime);
     ...
     */
    VIGIL_API const vigil_token_t *vigil_token_list_get(const vigil_token_list_t *list, size_t index);
