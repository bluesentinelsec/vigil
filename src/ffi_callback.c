...
static intptr_t cb_invoke(int slot, intptr_t a0, intptr_t a1, intptr_t a2, intptr_t a3)
{
    ...
    callback_unlock();
    if (dispatch)
        return dispatch(slot, a0, a1, a2, a3);
    return 0;
}

#define CB_SLOT(N)                                                                                                     \
    static intptr_t cb_slot##N(intptr_t a0, intptr_t a1, intptr_t a2, intptr_t a3)                                     \
    {                                                                                                                  \
