...
static const vigil_doc_entry_t fs_docs[] = {
    ...
    {"fs.remove_all", "fs.remove_all(path: string) -> bool", "Recursively delete directory.", "Removes a file or directory tree recursively.", "fs.remove_all(\"build\")"},
    ...
    {"fs.is_symlink", "fs.is_symlink(path: string) -> bool", "Check if path is symlink.", "Returns true if path is a symbolic link.", "fs.is_symlink(\"link.txt\")"},
    ...
    {"fs.glob", "fs.glob(dir: string, pattern: string) -> array<string>", "Glob match directory.", "Returns files matching a glob pattern (*, ?).", "fs.glob(\"src\", \"*.vigil\")"},
    {"fs.symlink", "fs.symlink(target: string, link: string) -> bool", "Create symbolic link.", "Creates a symbolic link pointing to target.", "fs.symlink(\"file.txt\", \"link.txt\")"},
    {"fs.readlink", "fs.readlink(path: string) -> string", "Read symlink target.", "Returns the target path of a symbolic link.", "fs.readlink(\"link.txt\")"},
...
static const vigil_doc_entry_t compress_docs[] = {
    ...
    {"compress.deflate_compress_level", "compress.deflate_compress_level(data: string, level: i32) -> string", "Compress with raw deflate at level.", "Level 0=store, 1=fast, 9=best, 10=uber.", "compress.deflate_compress_level(data, 9)"},
    ...
    {"compress.zlib_compress_level", "compress.zlib_compress_level(data: string, level: i32) -> string", "Compress with zlib at level.", "Level 0=store, 1=fast, 9=best, 10=uber.", "compress.zlib_compress_level(data, 9)"},
    ...
    {"compress.gzip_compress_level", "compress.gzip_compress_level(data: string, level: i32) -> string", "Compress with gzip at level.", "Level 0=store, 1=fast, 9=best. Sets XFL header byte.", "compress.gzip_compress_level(data, 9)"},
    ...
    {"compress.crc32", "compress.crc32(data: string) -> i64", "Compute CRC-32 checksum.", "Returns CRC-32 of the input data.", "compress.crc32(\"hello\")"},
    {"compress.adler32", "compress.adler32(data: string) -> i64", "Compute Adler-32 checksum.", "Returns Adler-32 of the input data.", "compress.adler32(\"hello\")"},
