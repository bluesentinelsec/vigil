...
static vigil_status_t vigil_string_validate_mutable(
...
static int vigil_string_overlaps_storage(
    const vigil_string_t *string,
    const char *value,
    size_t length
) {
...
static vigil_status_t vigil_string_copy_input(
...
static vigil_status_t vigil_string_prepare_storage(
    vigil_string_t *string,
    size_t length,
    vigil_error_t *error
) {
...
vigil_status_t vigil_string_reserve(
    vigil_string_t *string,
    size_t length,
    vigil_error_t *error
) {
...
vigil_status_t vigil_string_assign(
    vigil_string_t *string,
    const char *value,
    size_t length,
    vigil_error_t *error
...
vigil_status_t vigil_string_assign_cstr(
    vigil_string_t *string,
    const char *value,
    vigil_error_t *error
) {
...
vigil_status_t vigil_string_append(
    vigil_string_t *string,
    const char *value,
    size_t length,
    vigil_error_t *error
...
vigil_status_t vigil_string_append_cstr(
    vigil_string_t *string,
    const char *value,
    vigil_error_t *error
) {
