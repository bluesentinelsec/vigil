...
static vigil_status_t vigil_byte_buffer_validate(
    const vigil_byte_buffer_t *buffer,
    vigil_error_t *error
) {
...
static vigil_status_t vigil_byte_buffer_grow(
...
vigil_status_t vigil_byte_buffer_reserve(
    vigil_byte_buffer_t *buffer,
    size_t capacity,
    vigil_error_t *error
) {
...
vigil_status_t vigil_byte_buffer_resize(
    vigil_byte_buffer_t *buffer,
    size_t length,
    vigil_error_t *error
) {
...
vigil_status_t vigil_byte_buffer_append(
    vigil_byte_buffer_t *buffer,
    const void *data,
    size_t length,
    vigil_error_t *error
...
vigil_status_t vigil_byte_buffer_append_byte(
    vigil_byte_buffer_t *buffer,
    uint8_t value,
    vigil_error_t *error
) {
