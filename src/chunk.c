...
static vigil_status_t vigil_chunk_validate_mutable(
...
static vigil_status_t vigil_chunk_validate_output(
    const vigil_chunk_t *chunk,
    const vigil_string_t *output,
    vigil_error_t *error
) {
...
static vigil_status_t vigil_chunk_grow_spans(
    vigil_chunk_t *chunk,
    ...
    if (chunk->spans == NULL) {
        ...
        memset(
            (vigil_source_span_t *)memory + old_capacity,
            0,
...
static vigil_status_t vigil_chunk_grow_constants(
    vigil_chunk_t *chunk,
    size_t minimum_capacity,
    vigil_error_t *error
) {
...
static vigil_status_t vigil_chunk_append_bytes(
    vigil_chunk_t *chunk,
    const uint8_t *bytes,
    size_t byte_count,
...
static vigil_status_t vigil_chunk_append_text(
...
static vigil_status_t vigil_chunk_append_value(
    vigil_string_t *output,
    ...
    switch (vigil_value_kind(value)) {
        ...
        case VIGIL_VALUE_BOOL:
            return vigil_chunk_append_text(
                output,
                vigil_value_as_bool(value) ? "true" : "false",
                error
            );
        ...
        case VIGIL_VALUE_OBJECT:
            ...
            if (vigil_object_type(object) == VIGIL_OBJECT_STRING) {
                ...
                status = vigil_string_append_cstr(
                    output,
                    vigil_string_object_c_str(object),
                    error
                );
                if (status != VIGIL_STATUS_OK) {
                    return status;
...
const vigil_value_t *vigil_chunk_constant(
    const vigil_chunk_t *chunk,
    size_t index
) {
...
vigil_source_span_t vigil_chunk_span_at(
    const vigil_chunk_t *chunk,
    size_t offset
) {
    vigil_source_span_t span;
...
const char *vigil_opcode_name(vigil_opcode_t opcode) {
    switch (opcode) {
        ...
        case VIGIL_OPCODE_MAP_VALUES:
            return "MAP_VALUES";
        case VIGIL_OPCODE_ADD_I64:           return "ADD_I64";
        case VIGIL_OPCODE_SUBTRACT_I64:      return "SUBTRACT_I64";
        case VIGIL_OPCODE_LESS_I64:          return "LESS_I64";
        case VIGIL_OPCODE_LESS_EQUAL_I64:    return "LESS_EQUAL_I64";
        case VIGIL_OPCODE_GREATER_I64:       return "GREATER_I64";
        case VIGIL_OPCODE_GREATER_EQUAL_I64: return "GREATER_EQUAL_I64";
        case VIGIL_OPCODE_MULTIPLY_I64:      return "MULTIPLY_I64";
        case VIGIL_OPCODE_DIVIDE_I64:        return "DIVIDE_I64";
        case VIGIL_OPCODE_MODULO_I64:        return "MODULO_I64";
        case VIGIL_OPCODE_EQUAL_I64:         return "EQUAL_I64";
        case VIGIL_OPCODE_NOT_EQUAL_I64:     return "NOT_EQUAL_I64";
        case VIGIL_OPCODE_LOCALS_ADD_I64:    return "LOCALS_ADD_I64";
        case VIGIL_OPCODE_LOCALS_SUBTRACT_I64: return "LOCALS_SUBTRACT_I64";
        case VIGIL_OPCODE_LOCALS_MULTIPLY_I64: return "LOCALS_MULTIPLY_I64";
        case VIGIL_OPCODE_LOCALS_MODULO_I64: return "LOCALS_MODULO_I64";
        case VIGIL_OPCODE_LOCALS_LESS_I64:   return "LOCALS_LESS_I64";
        case VIGIL_OPCODE_LOCALS_LESS_EQUAL_I64: return "LOCALS_LESS_EQUAL_I64";
        case VIGIL_OPCODE_LOCALS_GREATER_I64: return "LOCALS_GREATER_I64";
        case VIGIL_OPCODE_LOCALS_GREATER_EQUAL_I64: return "LOCALS_GREATER_EQUAL_I64";
        case VIGIL_OPCODE_LOCALS_EQUAL_I64:  return "LOCALS_EQUAL_I64";
        case VIGIL_OPCODE_LOCALS_NOT_EQUAL_I64: return "LOCALS_NOT_EQUAL_I64";
        case VIGIL_OPCODE_ADD_I32:           return "ADD_I32";
        case VIGIL_OPCODE_SUBTRACT_I32:      return "SUBTRACT_I32";
        case VIGIL_OPCODE_MULTIPLY_I32:      return "MULTIPLY_I32";
        case VIGIL_OPCODE_LESS_I32:          return "LESS_I32";
        case VIGIL_OPCODE_LESS_EQUAL_I32:    return "LESS_EQUAL_I32";
        case VIGIL_OPCODE_GREATER_I32:       return "GREATER_I32";
        case VIGIL_OPCODE_GREATER_EQUAL_I32: return "GREATER_EQUAL_I32";
        case VIGIL_OPCODE_EQUAL_I32:         return "EQUAL_I32";
        case VIGIL_OPCODE_NOT_EQUAL_I32:     return "NOT_EQUAL_I32";
        case VIGIL_OPCODE_MODULO_I32:        return "MODULO_I32";
        case VIGIL_OPCODE_DIVIDE_I32:        return "DIVIDE_I32";
        case VIGIL_OPCODE_LOCALS_ADD_I32_STORE: return "LOCALS_ADD_I32_STORE";
        case VIGIL_OPCODE_LOCALS_SUBTRACT_I32_STORE: return "LOCALS_SUBTRACT_I32_STORE";
        case VIGIL_OPCODE_LOCALS_MULTIPLY_I32_STORE: return "LOCALS_MULTIPLY_I32_STORE";
        case VIGIL_OPCODE_LOCALS_LESS_I32_STORE: return "LOCALS_LESS_I32_STORE";
        case VIGIL_OPCODE_LOCALS_LESS_EQUAL_I32_STORE: return "LOCALS_LESS_EQUAL_I32_STORE";
        case VIGIL_OPCODE_LOCALS_GREATER_I32_STORE: return "LOCALS_GREATER_I32_STORE";
        case VIGIL_OPCODE_LOCALS_GREATER_EQUAL_I32_STORE: return "LOCALS_GREATER_EQUAL_I32_STORE";
        case VIGIL_OPCODE_LOCALS_EQUAL_I32_STORE: return "LOCALS_EQUAL_I32_STORE";
        case VIGIL_OPCODE_LOCALS_NOT_EQUAL_I32_STORE: return "LOCALS_NOT_EQUAL_I32_STORE";
        case VIGIL_OPCODE_LOCALS_MODULO_I32_STORE: return "LOCALS_MODULO_I32_STORE";
        case VIGIL_OPCODE_INCREMENT_LOCAL_I32: return "INCREMENT_LOCAL_I32";
        case VIGIL_OPCODE_TAIL_CALL: return "TAIL_CALL";
        case VIGIL_OPCODE_FORLOOP_I32: return "FORLOOP_I32";
        case VIGIL_OPCODE_CALL_NATIVE: return "CALL_NATIVE";
        case VIGIL_OPCODE_DEFER_CALL_NATIVE: return "DEFER_CALL_NATIVE";
        case VIGIL_OPCODE_STRING_TRIM_LEFT: return "STRING_TRIM_LEFT";
        case VIGIL_OPCODE_STRING_TRIM_RIGHT: return "STRING_TRIM_RIGHT";
        case VIGIL_OPCODE_STRING_REPEAT: return "STRING_REPEAT";
        case VIGIL_OPCODE_STRING_REVERSE: return "STRING_REVERSE";
        case VIGIL_OPCODE_STRING_IS_EMPTY: return "STRING_IS_EMPTY";
        case VIGIL_OPCODE_STRING_COUNT: return "STRING_COUNT";
        case VIGIL_OPCODE_STRING_LAST_INDEX_OF: return "STRING_LAST_INDEX_OF";
        case VIGIL_OPCODE_STRING_TRIM_PREFIX: return "STRING_TRIM_PREFIX";
        case VIGIL_OPCODE_STRING_TRIM_SUFFIX: return "STRING_TRIM_SUFFIX";
        case VIGIL_OPCODE_CHAR_FROM_INT: return "CHAR_FROM_INT";
        case VIGIL_OPCODE_STRING_TO_C: return "STRING_TO_C";
        case VIGIL_OPCODE_STRING_JOIN: return "STRING_JOIN";
        case VIGIL_OPCODE_STRING_CUT: return "STRING_CUT";
        case VIGIL_OPCODE_STRING_FIELDS: return "STRING_FIELDS";
        case VIGIL_OPCODE_STRING_EQUAL_FOLD: return "STRING_EQUAL_FOLD";
        case VIGIL_OPCODE_STRING_CHAR_COUNT: return "STRING_CHAR_COUNT";
        case VIGIL_OPCODE_FORMAT_SPEC: return "FORMAT_SPEC";
        default:
            return "UNKNOWN";
    }
}

vigil_status_t vigil_chunk_write_byte(
    vigil_chunk_t *chunk,
    uint8_t value,
    vigil_source_span_t span,
    vigil_error_t *error
...
vigil_status_t vigil_chunk_write_opcode(
    vigil_chunk_t *chunk,
...
vigil_status_t vigil_chunk_write_u32(
    vigil_chunk_t *chunk,
    uint32_t value,
    vigil_source_span_t span,
    vigil_error_t *error
...
vigil_status_t vigil_chunk_add_constant(
    vigil_chunk_t *chunk,
    const vigil_value_t *value,
    size_t *out_index,
    vigil_error_t *error
...
vigil_status_t vigil_chunk_write_constant(
    vigil_chunk_t *chunk,
    const vigil_value_t *value,
    vigil_source_span_t span,
    size_t *out_index,
...
vigil_status_t vigil_chunk_disassemble(
    const vigil_chunk_t *chunk,
    vigil_string_t *output,
    vigil_error_t *error
) {
    ...
    for (offset = 0U; offset < chunk->code.length; ) {
        ...
        if (
            opcode == VIGIL_OPCODE_CALL ||
            opcode == VIGIL_OPCODE_DEFER_CALL
        ) {
            ...
            opcode == VIGIL_OPCODE_CALL_VALUE ||
            opcode == VIGIL_OPCODE_DEFER_CALL_VALUE
        ) {
            ...
            opcode == VIGIL_OPCODE_CALL_INTERFACE ||
            opcode == VIGIL_OPCODE_DEFER_CALL_INTERFACE
        ) {
            ...
            opcode == VIGIL_OPCODE_NEW_INSTANCE ||
            opcode == VIGIL_OPCODE_NEW_ARRAY ||
            opcode == VIGIL_OPCODE_NEW_MAP ||
            opcode == VIGIL_OPCODE_DEFER_NEW_INSTANCE ||
            ...
            opcode == VIGIL_OPCODE_CONSTANT ||
            opcode == VIGIL_OPCODE_GET_LOCAL ||
            opcode == VIGIL_OPCODE_SET_LOCAL ||
            opcode == VIGIL_OPCODE_GET_GLOBAL ||
            opcode == VIGIL_OPCODE_SET_GLOBAL ||
            opcode == VIGIL_OPCODE_GET_FUNCTION ||
            opcode == VIGIL_OPCODE_GET_CAPTURE ||
            opcode == VIGIL_OPCODE_SET_CAPTURE ||
            opcode == VIGIL_OPCODE_JUMP ||
            opcode == VIGIL_OPCODE_JUMP_IF_FALSE ||
            opcode == VIGIL_OPCODE_LOOP ||
            opcode == VIGIL_OPCODE_FORMAT_F64 ||
            opcode == VIGIL_OPCODE_GET_FIELD ||
            ...
            if (opcode == VIGIL_OPCODE_CONSTANT) {
                ...
                status = vigil_chunk_append_value(
                    output,
                    vigil_chunk_constant(chunk, (size_t)operand),
                    error
                );
                if (status != VIGIL_STATUS_OK) {
                    return status;
            ...
            opcode == VIGIL_OPCODE_GET_INDEX ||
            opcode == VIGIL_OPCODE_SET_INDEX ||
            opcode == VIGIL_OPCODE_GET_COLLECTION_SIZE ||
            opcode == VIGIL_OPCODE_GET_MAP_KEY_AT ||
            opcode == VIGIL_OPCODE_GET_MAP_VALUE_AT ||
            opcode == VIGIL_OPCODE_GET_STRING_SIZE ||
            opcode == VIGIL_OPCODE_STRING_CONTAINS ||
            opcode == VIGIL_OPCODE_STRING_STARTS_WITH ||
            opcode == VIGIL_OPCODE_STRING_ENDS_WITH ||
            opcode == VIGIL_OPCODE_STRING_TRIM ||
            opcode == VIGIL_OPCODE_STRING_TO_UPPER ||
            opcode == VIGIL_OPCODE_STRING_TO_LOWER ||
            opcode == VIGIL_OPCODE_STRING_REPLACE ||
            opcode == VIGIL_OPCODE_STRING_SPLIT ||
            opcode == VIGIL_OPCODE_STRING_INDEX_OF ||
            opcode == VIGIL_OPCODE_STRING_SUBSTR ||
            opcode == VIGIL_OPCODE_STRING_BYTES ||
            opcode == VIGIL_OPCODE_STRING_CHAR_AT ||
            opcode == VIGIL_OPCODE_ARRAY_PUSH ||
            opcode == VIGIL_OPCODE_ARRAY_POP ||
            opcode == VIGIL_OPCODE_ARRAY_GET_SAFE ||
            opcode == VIGIL_OPCODE_ARRAY_SET_SAFE ||
            opcode == VIGIL_OPCODE_ARRAY_SLICE ||
            opcode == VIGIL_OPCODE_ARRAY_CONTAINS ||
            opcode == VIGIL_OPCODE_MAP_GET_SAFE ||
            opcode == VIGIL_OPCODE_MAP_SET_SAFE ||
            opcode == VIGIL_OPCODE_MAP_REMOVE_SAFE ||
            opcode == VIGIL_OPCODE_MAP_HAS ||
            opcode == VIGIL_OPCODE_MAP_KEYS ||
            opcode == VIGIL_OPCODE_MAP_VALUES ||
