 ...
 */
static const char *pop_str_buf(vigil_vm_t *vm, size_t base, size_t idx,
...
#ifdef VIGIL_HAS_LIBFFI
static vigil_status_t push_string(vigil_vm_t *vm, const char *s,
                                  vigil_error_t *error) {
...
static vigil_status_t vigil_ffi_open(
...
static vigil_status_t vigil_ffi_sym(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
...
static vigil_status_t vigil_ffi_close(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    void *handle = (void *)(intptr_t)pop_i64(vm, base, 0);
...
static vigil_status_t vigil_ffi_bind(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    void *handle = (void *)(intptr_t)pop_i64(vm, base, 0);
...
static vigil_status_t vigil_ffi_call(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
...
static vigil_status_t vigil_ffi_call_f(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    int idx = (int)pop_i64(vm, base, 0);
...
static vigil_status_t vigil_ffi_call_s(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    int idx = (int)pop_i64(vm, base, 0);
...
static const int p_i64_str_str[] = { VIGIL_TYPE_I64, VIGIL_TYPE_STRING,
                                      VIGIL_TYPE_STRING };
static const int p_call[] = { VIGIL_TYPE_I64, VIGIL_TYPE_I64, VIGIL_TYPE_I64,
...
VIGIL_API const vigil_native_module_t vigil_stdlib_ffi = {
    "ffi", 3U,
    vigil_ffi_functions,
    sizeof(vigil_ffi_functions) / sizeof(vigil_ffi_functions[0]),
    NULL, 0U
};
