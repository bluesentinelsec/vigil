...
static vigil_status_t vigil_math_push_f64(
    vigil_vm_t *vm, double d, vigil_error_t *error
) {
    vigil_value_t val = vigil_nanbox_encode_double(d);
    return vigil_vm_stack_push(vm, &val, error);
}

static vigil_status_t vigil_math_push_bool(
    vigil_vm_t *vm, int b, vigil_error_t *error
) {
    vigil_value_t val;
...
#define MATH_UNARY(name, cfn)                                       \
    static vigil_status_t vigil_math_##name(                          \
...
static vigil_status_t vigil_math_pi(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    (void)arg_count;
...
static vigil_status_t vigil_math_e(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    (void)arg_count;
...
static vigil_status_t vigil_math_tau(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    (void)arg_count;
...
static vigil_status_t vigil_math_epsilon(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    (void)arg_count;
...
static vigil_status_t vigil_math_is_nan(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    (void)arg_count;
...
static vigil_status_t vigil_math_is_inf(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    (void)arg_count;
    double a = vigil_math_pop_f64(vm);
...
static vigil_status_t vigil_math_is_finite(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    (void)arg_count;
    double a = vigil_math_pop_f64(vm);
...
static vigil_status_t vigil_math_pow(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
...
static vigil_status_t vigil_math_min(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    double a, b;
    (void)arg_count;
...
static vigil_status_t vigil_math_max(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    double a, b;
    (void)arg_count;
...
static vigil_status_t vigil_math_atan2(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    double y, x;
    (void)arg_count;
...
static vigil_status_t vigil_math_hypot(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    double a, b;
    (void)arg_count;
...
static vigil_status_t vigil_math_fmod(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    double a, b;
    (void)arg_count;
...
static vigil_status_t vigil_math_sign(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    double a;
    (void)arg_count;
...
static vigil_status_t vigil_math_deg2rad(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    (void)arg_count;
...
static vigil_status_t vigil_math_rad2deg(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    (void)arg_count;
...
static vigil_status_t vigil_math_clamp(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    double val, lo, hi;
    (void)arg_count;
...
static vigil_status_t vigil_math_lerp(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    (void)arg_count;
...
static vigil_status_t vigil_math_normalize(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    (void)arg_count;
...
static vigil_status_t vigil_math_wrap(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    (void)arg_count;
    ...
    double val = vigil_math_pop_f64(vm);
    double range = hi - lo;
    if (range == 0.0) return vigil_math_push_f64(vm, lo, error);
...
static const int vigil_math_f64x5_params[] = {
    VIGIL_TYPE_F64, VIGIL_TYPE_F64, VIGIL_TYPE_F64,
    VIGIL_TYPE_F64, VIGIL_TYPE_F64
};

static vigil_status_t vigil_math_remap(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    (void)arg_count;
...
static vigil_status_t vigil_math_inverselerp(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    (void)arg_count;
    double val = vigil_math_pop_f64(vm);
...
static vigil_status_t vigil_math_smoothstep(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    (void)arg_count;
...
static vigil_status_t vigil_math_step(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    (void)arg_count;
    double x = vigil_math_pop_f64(vm);
...
static const int vigil_math_f64f64_params[] = {
    VIGIL_TYPE_F64, VIGIL_TYPE_F64
};
static const int vigil_math_f64f64f64_params[] = {
    VIGIL_TYPE_F64, VIGIL_TYPE_F64, VIGIL_TYPE_F64
};

#define MATH_FN0(id, n, nl)                                         \
    { n, nl, vigil_math_##id, 0U, NULL,                             \
      VIGIL_TYPE_F64, 1U, NULL, 0, NULL, NULL }

#define MATH_FN1(id, n, nl)                                         \
    { n, nl, vigil_math_##id, 1U, vigil_math_f64_params,             \
      VIGIL_TYPE_F64, 1U, NULL, 0, NULL, NULL }

#define MATH_FN1_BOOL(id, n, nl)                                    \
    { n, nl, vigil_math_##id, 1U, vigil_math_f64_params,             \
      VIGIL_TYPE_BOOL, 1U, NULL, 0, NULL, NULL }

#define MATH_FN2(id, n, nl)                                         \
    { n, nl, vigil_math_##id, 2U, vigil_math_f64f64_params,          \
      VIGIL_TYPE_F64, 1U, NULL, 0, NULL, NULL }

#define MATH_FN3(id, n, nl)                                         \
    { n, nl, vigil_math_##id, 3U, vigil_math_f64f64f64_params,       \
      VIGIL_TYPE_F64, 1U, NULL, 0, NULL, NULL }

#define MATH_FN5(id, n, nl)                                         \
    { n, nl, vigil_math_##id, 5U, vigil_math_f64x5_params,           \
      VIGIL_TYPE_F64, 1U, NULL, 0, NULL, NULL }
...
#define VIGIL_MATH_FUNCTION_COUNT \
    (sizeof(vigil_math_functions) / sizeof(vigil_math_functions[0]))
...
static vigil_status_t vigil_mat4_push_new(
    vigil_vm_t *vm, const double m[16], size_t class_index,
    vigil_error_t *error);

/* Helper: push a new Vec2 instance with given x, y. */
static vigil_status_t vigil_vec2_push_new(
    vigil_vm_t *vm, double x, double y, size_t class_index,
    vigil_error_t *error
) {
...
static vigil_status_t vigil_vec2_length(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
...
static vigil_status_t vigil_vec2_dot(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
...
static vigil_status_t vigil_vec2_vnormalize(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x = vigil_vec_get_field(vm, base, 0U);
    ...
    vigil_vm_stack_pop_n(vm, arg_count);
    if (len == 0.0) return vigil_vec2_push_new(vm, 0.0, 0.0, ci, error);
    return vigil_vec2_push_new(vm, x / len, y / len, ci, error);
}

static vigil_status_t vigil_vec2_add(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x1 = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_vec2_sub(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x1 = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_vec2_scale(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_vec2_distance(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
...
static vigil_status_t vigil_vec2_lengthsqr(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_vec2_negate(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_vec2_vlerp(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x1 = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_vec2_reflect(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
...
static vigil_status_t vigil_vec2_angle(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_vec2_rotate(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x = vigil_vec_get_field(vm, base, 0U);
...
/* Vec2.zero() */
static vigil_status_t vigil_vec2_zero(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
...
/* Vec2.one() */
static vigil_status_t vigil_vec2_one(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    size_t ci = vigil_static_class_index(vm, base);
...
static const vigil_native_class_method_t vigil_vec2_methods[] = {
    VIGIL_STATIC("zero",      4U, vigil_vec2_zero,       0U, NULL,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_STATIC("one",       3U, vigil_vec2_one,        0U, NULL,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("length",    6U, vigil_vec2_length,     0U, NULL,
      VIGIL_TYPE_F64, 1U, NULL),
    VIGIL_METHOD("lengthSqr", 9U, vigil_vec2_lengthsqr, 0U, NULL,
      VIGIL_TYPE_F64, 1U, NULL),
    VIGIL_METHOD("dot",       3U, vigil_vec2_dot,        1U, vigil_vec_obj_params,
      VIGIL_TYPE_F64, 1U, NULL),
    VIGIL_METHOD("distance",  8U, vigil_vec2_distance,   1U, vigil_vec_obj_params,
      VIGIL_TYPE_F64, 1U, NULL),
    VIGIL_METHOD("normalize", 9U, vigil_vec2_vnormalize, 0U, NULL,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("negate",    6U, vigil_vec2_negate,     0U, NULL,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("add",       3U, vigil_vec2_add,        1U, vigil_vec_obj_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("sub",       3U, vigil_vec2_sub,        1U, vigil_vec_obj_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("scale",     5U, vigil_vec2_scale,      1U, vigil_vec_f64_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("lerp",      4U, vigil_vec2_vlerp,      2U, vigil_vec_obj_f64_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("reflect",   7U, vigil_vec2_reflect,    1U, vigil_vec_obj_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("angle",     5U, vigil_vec2_angle,      0U, NULL,
      VIGIL_TYPE_F64, 1U, NULL),
    VIGIL_METHOD("rotate",    6U, vigil_vec2_rotate,     1U, vigil_vec_f64_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
};

/* ── Vec3 class ──────────────────────────────────────────────────── */

static vigil_status_t vigil_vec3_push_new(
    vigil_vm_t *vm, double x, double y, double z, size_t class_index,
    vigil_error_t *error
) {
    vigil_runtime_t *rt = vigil_vm_runtime(vm);
...
static vigil_status_t vigil_vec3_length(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_vec3_dot(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x1 = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_vec3_cross(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x1 = vigil_vec_get_field(vm, base, 0U);
    ...
    size_t ci = vigil_vec_self_class(vm, base);
    vigil_vm_stack_pop_n(vm, arg_count);
    return vigil_vec3_push_new(vm,
        y1*z2 - z1*y2,
        z1*x2 - x1*z2,
        x1*y2 - y1*x2, ci, error);
}

static vigil_status_t vigil_vec3_vnormalize(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x = vigil_vec_get_field(vm, base, 0U);
    ...
    vigil_vm_stack_pop_n(vm, arg_count);
    if (len == 0.0) return vigil_vec3_push_new(vm, 0.0, 0.0, 0.0, ci, error);
    return vigil_vec3_push_new(vm, x/len, y/len, z/len, ci, error);
}

static vigil_status_t vigil_vec3_add(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x1 = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_vec3_sub(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x1 = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_vec3_scale(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_vec3_distance(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double dx = vigil_vec_get_field(vm, base, 0U) - vigil_vec_get_field(vm, base + 1U, 0U);
...
static vigil_status_t vigil_vec3_lengthsqr(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_vec3_negate(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_vec3_vlerp(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x1 = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_vec3_reflect(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double vx = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_vec3_angle(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x1 = vigil_vec_get_field(vm, base, 0U);
    ...
    double cosA;
    vigil_vm_stack_pop_n(vm, arg_count);
    if (denom == 0.0) return vigil_math_push_f64(vm, 0.0, error);
    cosA = dot / denom;
...
static vigil_status_t vigil_vec3_transform(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x = vigil_vec_get_field(vm, base, 0U);
    ...
    for (i = 0; i < 16; i++) m[i] = vigil_mat4_read(arr, i);
...
static vigil_status_t vigil_vec3_rotate_by_quat(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double vx = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_vec3_unproject(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    ...
    size_t i; int c, r, k;
    for (i = 0; i < 16; i++) { p[i] = vigil_mat4_read(parr, i); v[i] = vigil_mat4_read(varr, i); }
    /* vp = v * p */
...
/* Vec3.zero() */
static vigil_status_t vigil_vec3_zero(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    size_t ci = vigil_static_class_index(vm, base);
...
/* Vec3.one() */
static vigil_status_t vigil_vec3_one(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    size_t ci = vigil_static_class_index(vm, base);
...
static const vigil_native_class_method_t vigil_vec3_methods[] = {
    VIGIL_STATIC("zero",      4U, vigil_vec3_zero,       0U, NULL,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_STATIC("one",       3U, vigil_vec3_one,        0U, NULL,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("length",    6U, vigil_vec3_length,     0U, NULL,
      VIGIL_TYPE_F64, 1U, NULL),
    VIGIL_METHOD("lengthSqr", 9U, vigil_vec3_lengthsqr, 0U, NULL,
      VIGIL_TYPE_F64, 1U, NULL),
    VIGIL_METHOD("dot",       3U, vigil_vec3_dot,        1U, vigil_vec_obj_params,
      VIGIL_TYPE_F64, 1U, NULL),
    VIGIL_METHOD("distance",  8U, vigil_vec3_distance,   1U, vigil_vec_obj_params,
      VIGIL_TYPE_F64, 1U, NULL),
    VIGIL_METHOD("angle",     5U, vigil_vec3_angle,      1U, vigil_vec_obj_params,
      VIGIL_TYPE_F64, 1U, NULL),
    VIGIL_METHOD("cross",     5U, vigil_vec3_cross,      1U, vigil_vec_obj_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("normalize", 9U, vigil_vec3_vnormalize, 0U, NULL,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("negate",    6U, vigil_vec3_negate,     0U, NULL,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("add",       3U, vigil_vec3_add,        1U, vigil_vec_obj_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("sub",       3U, vigil_vec3_sub,        1U, vigil_vec_obj_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("scale",     5U, vigil_vec3_scale,      1U, vigil_vec_f64_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("lerp",      4U, vigil_vec3_vlerp,      2U, vigil_vec_obj_f64_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("reflect",   7U, vigil_vec3_reflect,    1U, vigil_vec_obj_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("transform", 9U, vigil_vec3_transform,  1U, vigil_vec_obj_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("rotateByQuaternion", 18U, vigil_vec3_rotate_by_quat, 1U, vigil_vec_obj_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("unproject", 9U, vigil_vec3_unproject,  2U, vigil_vec_obj_obj_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
};

/* ── Vec4 class ──────────────────────────────────────────────────── */

static vigil_status_t vigil_vec4_push_new(
    vigil_vm_t *vm, double x, double y, double z, double w,
    size_t class_index, vigil_error_t *error
) {
    vigil_runtime_t *rt = vigil_vm_runtime(vm);
...
static vigil_status_t vigil_vec4_length(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_vec4_lengthsqr(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_vec4_dot(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
...
static vigil_status_t vigil_vec4_distance(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double dx = vigil_vec_get_field(vm, base, 0U) - vigil_vec_get_field(vm, base+1U, 0U);
...
static vigil_status_t vigil_vec4_vnormalize(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x = vigil_vec_get_field(vm, base, 0U);
    ...
    vigil_vm_stack_pop_n(vm, arg_count);
    if (len == 0.0) return vigil_vec4_push_new(vm, 0, 0, 0, 0, ci, error);
    return vigil_vec4_push_new(vm, x/len, y/len, z/len, w/len, ci, error);
}

static vigil_status_t vigil_vec4_negate(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    size_t ci = vigil_vec_self_class(vm, base);
...
static vigil_status_t vigil_vec4_add(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    size_t ci = vigil_vec_self_class(vm, base);
...
static vigil_status_t vigil_vec4_sub(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    size_t ci = vigil_vec_self_class(vm, base);
...
static vigil_status_t vigil_vec4_scale(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    size_t ci = vigil_vec_self_class(vm, base);
...
static vigil_status_t vigil_vec4_vlerp(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    size_t ci = vigil_vec_self_class(vm, base);
...
/* Vec4.zero() */
static vigil_status_t vigil_vec4_zero(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    size_t ci = vigil_static_class_index(vm, base);
...
/* Vec4.one() */
static vigil_status_t vigil_vec4_one(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    size_t ci = vigil_static_class_index(vm, base);
...
static const vigil_native_class_method_t vigil_vec4_methods[] = {
    VIGIL_STATIC("zero",      4U, vigil_vec4_zero,       0U, NULL,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_STATIC("one",       3U, vigil_vec4_one,        0U, NULL,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("length",    6U, vigil_vec4_length,     0U, NULL,
      VIGIL_TYPE_F64, 1U, NULL),
    VIGIL_METHOD("lengthSqr", 9U, vigil_vec4_lengthsqr, 0U, NULL,
      VIGIL_TYPE_F64, 1U, NULL),
    VIGIL_METHOD("dot",       3U, vigil_vec4_dot,        1U, vigil_vec_obj_params,
      VIGIL_TYPE_F64, 1U, NULL),
    VIGIL_METHOD("distance",  8U, vigil_vec4_distance,   1U, vigil_vec_obj_params,
      VIGIL_TYPE_F64, 1U, NULL),
    VIGIL_METHOD("normalize", 9U, vigil_vec4_vnormalize, 0U, NULL,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("negate",    6U, vigil_vec4_negate,     0U, NULL,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("add",       3U, vigil_vec4_add,        1U, vigil_vec_obj_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("sub",       3U, vigil_vec4_sub,        1U, vigil_vec_obj_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("scale",     5U, vigil_vec4_scale,      1U, vigil_vec_f64_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("lerp",      4U, vigil_vec4_vlerp,      2U, vigil_vec_obj_f64_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
};
...
static vigil_status_t vigil_quat_length(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_quat_vnormalize(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x = vigil_vec_get_field(vm, base, 0U);
    ...
    double len = sqrt(x*x + y*y + z*z + w*w);
    vigil_vm_stack_pop_n(vm, arg_count);
    if (len == 0.0) return vigil_quat_push_new(vm, 0, 0, 0, 1, ci, error);
    return vigil_quat_push_new(vm, x/len, y/len, z/len, w/len, ci, error);
}

static vigil_status_t vigil_quat_conjugate(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_quat_inverse(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x = vigil_vec_get_field(vm, base, 0U);
    ...
    vigil_vm_stack_pop_n(vm, arg_count);
    if (lsq == 0.0) return vigil_quat_push_new(vm, 0, 0, 0, 1, ci, error);
    return vigil_quat_push_new(vm, -x/lsq, -y/lsq, -z/lsq, w/lsq, ci, error);
}

/* Hamilton product: q1 * q2 */
static vigil_status_t vigil_quat_multiply(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x1 = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_quat_dot(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double r = vigil_vec_get_field(vm, base, 0U) * vigil_vec_get_field(vm, base+1U, 0U)
...
static vigil_status_t vigil_quat_slerp(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x1 = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_quat_from_axis_angle(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
...
static vigil_status_t vigil_quat_to_euler(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    double x = vigil_vec_get_field(vm, base, 0U);
...
static vigil_status_t vigil_quat_from_euler(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    size_t ci = vigil_static_class_index(vm, base);
...
static vigil_status_t vigil_quat_to_mat4(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
...
static const vigil_native_class_method_t vigil_quat_methods[] = {
    VIGIL_METHOD("length",        6U, vigil_quat_length,          0U, NULL,
      VIGIL_TYPE_F64, 1U, NULL),
    VIGIL_METHOD("dot",           3U, vigil_quat_dot,             1U, vigil_vec_obj_params,
      VIGIL_TYPE_F64, 1U, NULL),
    VIGIL_METHOD("normalize",     9U, vigil_quat_vnormalize,      0U, NULL,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("conjugate",     9U, vigil_quat_conjugate,       0U, NULL,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("inverse",       7U, vigil_quat_inverse,         0U, NULL,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("multiply",      8U, vigil_quat_multiply,        1U, vigil_vec_obj_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("slerp",         5U, vigil_quat_slerp,           2U, vigil_vec_obj_f64_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_STATIC("fromAxisAngle", 13U, vigil_quat_from_axis_angle, 2U, vigil_vec_obj_f64_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_STATIC("fromEuler",    9U, vigil_quat_from_euler,       3U, vigil_quat_f64x3_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("toEuler",       7U, vigil_quat_to_euler,        0U, NULL,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD_RET("toMat4",    6U, vigil_quat_to_mat4,         0U, NULL,
      VIGIL_TYPE_OBJECT, 1U, NULL, "Mat4", 4U),
};
...
static vigil_status_t vigil_mat4_push_new(
    ...
    vigil_status_t s;
    size_t i;
    for (i = 0; i < 16; i++) items[i] = vigil_nanbox_encode_double(m[i]);
...
static vigil_status_t vigil_mat4_identity(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    size_t ci = vigil_static_class_index(vm, base);
...
/* get(row, col) -> f64 */
static vigil_status_t vigil_mat4_get(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
...
static vigil_status_t vigil_mat4_set(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    vigil_object_t *arr = vigil_mat4_get_data(vm, base);
...
/* multiply(Mat4) -> Mat4 */
static vigil_status_t vigil_mat4_multiply(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    ...
    for (c = 0; c < 4; c++) {
        for (r = 0; r < 4; r++) {
            double sum = 0.0;
            for (k = 0; k < 4; k++) {
                sum += vigil_mat4_read(a, k * 4 + r) *
                       vigil_mat4_read(b, c * 4 + k);
            }
            m[c * 4 + r] = sum;
        }
    }
...
/* transpose() -> Mat4 */
static vigil_status_t vigil_mat4_transpose(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    vigil_object_t *a = vigil_mat4_get_data(vm, base);
...
/* determinant() -> f64 */
static vigil_status_t vigil_mat4_determinant(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    vigil_object_t *a = vigil_mat4_get_data(vm, base);
    ...
    double det;
    size_t i;
    for (i = 0; i < 16; i++) m[i] = vigil_mat4_read(a, i);
...
/* add(Mat4) -> Mat4 */
static vigil_status_t vigil_mat4_add(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    vigil_object_t *a = vigil_mat4_get_data(vm, base);
    ...
    double m[16];
    size_t i;
    for (i = 0; i < 16; i++) m[i] = vigil_mat4_read(a, i) + vigil_mat4_read(b, i);
    vigil_vm_stack_pop_n(vm, arg_count);
    return vigil_mat4_push_new(vm, m, ci, error);
}

/* scale(f64) -> Mat4 (scalar multiply) */
static vigil_status_t vigil_mat4_scale(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    vigil_object_t *a = vigil_mat4_get_data(vm, base);
    ...
    double m[16];
    size_t i;
    for (i = 0; i < 16; i++) m[i] = vigil_mat4_read(a, i) * s;
    vigil_vm_stack_pop_n(vm, arg_count);
    return vigil_mat4_push_new(vm, m, ci, error);
}

/* trace() -> f64 */
static vigil_status_t vigil_mat4_trace(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    vigil_object_t *a = vigil_mat4_get_data(vm, base);
...
static vigil_status_t vigil_mat4_invert(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    vigil_object_t *a = vigil_mat4_get_data(vm, base);
...
static vigil_status_t vigil_mat4_translate(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    vigil_object_t *a = vigil_mat4_get_data(vm, base);
...
static vigil_status_t vigil_mat4_scale_vec(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    vigil_object_t *a = vigil_mat4_get_data(vm, base);
...
/* rotateX(angle) -> Mat4 */
static vigil_status_t vigil_mat4_rotate_x(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    vigil_object_t *a = vigil_mat4_get_data(vm, base);
...
/* rotateY(angle) -> Mat4 */
static vigil_status_t vigil_mat4_rotate_y(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    vigil_object_t *a = vigil_mat4_get_data(vm, base);
...
/* rotateZ(angle) -> Mat4 */
static vigil_status_t vigil_mat4_rotate_z(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    vigil_object_t *a = vigil_mat4_get_data(vm, base);
...
static vigil_status_t vigil_mat4_look_at(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    size_t ci = vigil_static_class_index(vm, base);
...
static const int vigil_mat4_f64x6_params[] = { VIGIL_TYPE_F64, VIGIL_TYPE_F64, VIGIL_TYPE_F64, VIGIL_TYPE_F64, VIGIL_TYPE_F64, VIGIL_TYPE_F64 };

/* Mat4.perspective(fovY, aspect, near, far) -> Mat4 (static) */
static vigil_status_t vigil_mat4_perspective(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    size_t ci = vigil_static_class_index(vm, base);
...
static vigil_status_t vigil_mat4_ortho(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    size_t ci = vigil_static_class_index(vm, base);
...
static vigil_status_t vigil_mat4_frustum(
    vigil_vm_t *vm, size_t arg_count, vigil_error_t *error
) {
    size_t base = vigil_vm_stack_depth(vm) - arg_count;
    size_t ci = vigil_static_class_index(vm, base);
...
static const int vigil_mat4_i32i32f64_params[] = {
    VIGIL_TYPE_I32, VIGIL_TYPE_I32, VIGIL_TYPE_F64
};

static const vigil_native_class_field_t vigil_mat4_fields[] = {
    { "data", 4U, VIGIL_TYPE_OBJECT,
      VIGIL_NATIVE_FIELD_ARRAY, NULL, 0U, VIGIL_TYPE_F64 },
};

static const vigil_native_class_method_t vigil_mat4_methods[] = {
    VIGIL_STATIC("identity",    8U, vigil_mat4_identity,    0U, NULL,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_STATIC("lookAt",      6U, vigil_mat4_look_at,     3U, vigil_mat4_obj3_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_STATIC("perspective", 11U, vigil_mat4_perspective, 4U, vigil_mat4_f64x4_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_STATIC("ortho",       5U, vigil_mat4_ortho,       6U, vigil_mat4_f64x6_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_STATIC("frustum",     7U, vigil_mat4_frustum,     6U, vigil_mat4_f64x6_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("get",         3U, vigil_mat4_get,         2U, vigil_mat4_i32i32_params,
      VIGIL_TYPE_F64, 1U, NULL),
    VIGIL_METHOD("set",         3U, vigil_mat4_set,         3U, vigil_mat4_i32i32f64_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("multiply",    8U, vigil_mat4_multiply,    1U, vigil_vec_obj_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("transpose",   9U, vigil_mat4_transpose,   0U, NULL,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("determinant", 11U, vigil_mat4_determinant, 0U, NULL,
      VIGIL_TYPE_F64, 1U, NULL),
    VIGIL_METHOD("trace",       5U, vigil_mat4_trace,       0U, NULL,
      VIGIL_TYPE_F64, 1U, NULL),
    VIGIL_METHOD("invert",      6U, vigil_mat4_invert,      0U, NULL,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("add",         3U, vigil_mat4_add,         1U, vigil_vec_obj_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("scale",       5U, vigil_mat4_scale,       1U, vigil_vec_f64_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("scaleV",      6U, vigil_mat4_scale_vec,   1U, vigil_vec_obj_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("translate",   9U, vigil_mat4_translate,   1U, vigil_vec_obj_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("rotateX",     7U, vigil_mat4_rotate_x,    1U, vigil_vec_f64_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("rotateY",     7U, vigil_mat4_rotate_y,    1U, vigil_vec_f64_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
    VIGIL_METHOD("rotateZ",     7U, vigil_mat4_rotate_z,    1U, vigil_vec_f64_params,
      VIGIL_TYPE_OBJECT, 1U, NULL),
};
...
static const vigil_native_class_t vigil_math_classes[] = {
    {
        "Vec2", 4U,
        vigil_vec2_fields, 2U,
        vigil_vec2_methods, 15U,
        NULL
    },
    {
        "Vec3", 4U,
        vigil_vec3_fields, 3U,
        vigil_vec3_methods, 18U,
        NULL
    },
    {
        "Vec4", 4U,
        vigil_vec4_fields, 4U,
        vigil_vec4_methods, 12U,
        NULL
    },
    {
        "Quaternion", 10U,
        vigil_quat_fields, 4U,
        vigil_quat_methods, 11U,
        NULL
    },
    {
        "Mat4", 4U,
        vigil_mat4_fields, 1U,
        vigil_mat4_methods, 19U,
        NULL
    },
};

#define VIGIL_MATH_CLASS_COUNT \
    (sizeof(vigil_math_classes) / sizeof(vigil_math_classes[0]))
