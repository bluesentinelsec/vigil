...
vigil_status_t vigil_program_grow_modules(
    ...
    if (memory == NULL) {
        ...
        if (status == VIGIL_STATUS_OK) {
            memset(
                (vigil_program_module_t *)memory + old_capacity,
                0,
...
vigil_status_t vigil_program_grow_classes(
    ...
    if (memory == NULL) {
        ...
        if (status == VIGIL_STATUS_OK) {
            memset(
                (vigil_class_decl_t *)memory + old_capacity,
                0,
...
vigil_status_t vigil_program_grow_interfaces(
    ...
    if (memory == NULL) {
        ...
        if (status == VIGIL_STATUS_OK) {
            memset(
                (vigil_interface_decl_t *)memory + old_capacity,
                0,
...
vigil_status_t vigil_program_grow_enums(
    ...
    if (memory == NULL) {
        ...
        if (status == VIGIL_STATUS_OK) {
            memset(
                (vigil_enum_decl_t *)memory + old_capacity,
                0,
...
vigil_status_t vigil_program_grow_array_types(
    ...
    if (memory == NULL) {
        ...
        if (status == VIGIL_STATUS_OK) {
            memset(
                (vigil_array_type_decl_t *)memory + old_capacity,
                0,
...
vigil_status_t vigil_program_grow_map_types(
    ...
    if (memory == NULL) {
        ...
        if (status == VIGIL_STATUS_OK) {
            memset(
                (vigil_map_type_decl_t *)memory + old_capacity,
                0,
...
int vigil_program_find_map_type(
    ...
    for (index = 0U; index < program->map_type_count; ++index) {
        if (
            vigil_parser_type_equal(program->map_types[index].key_type, key_type) &&
...
vigil_status_t vigil_program_intern_map_type(
    ...
    if (
        program == NULL ||
        !vigil_binding_type_is_valid(key_type) ||
        !vigil_binding_type_is_valid(value_type) ||
        out_type == NULL
    ) {
        vigil_error_set_literal(
            program == NULL ? NULL : program->error,
...
vigil_status_t vigil_function_type_decl_grow_params(
    ...
    if (memory == NULL) {
        ...
        if (status == VIGIL_STATUS_OK) {
            memset(
                (vigil_parser_type_t *)memory + old_capacity,
                0,
...
vigil_status_t vigil_program_grow_function_types(
    ...
    if (memory == NULL) {
        ...
        if (status == VIGIL_STATUS_OK) {
            memset(
                (vigil_function_type_decl_t *)memory + old_capacity,
                0,
...
int vigil_function_type_decl_matches(
    const vigil_function_type_decl_t *left,
    const vigil_function_type_decl_t *right
) {
    size_t index;
...
vigil_status_t vigil_program_intern_function_type(
    ...
    if (decl->param_count != 0U) {
        status = vigil_function_type_decl_grow_params(
            program,
    ...
    if (decl->return_count != 0U) {
        status = vigil_function_type_decl_grow_returns(
            program,
            &program->function_types[index],
            decl->return_count
        );
...
vigil_status_t vigil_program_intern_function_type_from_decl(
    ...
    for (index = 0U; index < decl->return_count; index += 1U) {
        status = vigil_function_type_decl_add_return(
            program,
            &function_type,
            vigil_function_return_type_at(decl, index)
        );
        if (status != VIGIL_STATUS_OK) {
            vigil_function_type_decl_free(program, &function_type);
            return status;
...
vigil_status_t vigil_class_decl_grow_fields(
    ...
    if (memory == NULL) {
        ...
        if (status == VIGIL_STATUS_OK) {
            memset(
                (vigil_class_field_t *)memory + old_capacity,
                0,
...
vigil_status_t vigil_class_decl_grow_methods(
    ...
    if (memory == NULL) {
        ...
        if (status == VIGIL_STATUS_OK) {
            memset(
                (vigil_class_method_t *)memory + old_capacity,
                0,
...
vigil_status_t vigil_class_decl_grow_interface_impls(
    ...
    if (memory == NULL) {
        ...
        if (status == VIGIL_STATUS_OK) {
            memset(
                (vigil_class_interface_impl_t *)memory + old_capacity,
                0,
...
vigil_status_t vigil_interface_decl_grow_methods(
    ...
    if (memory == NULL) {
        ...
        if (status == VIGIL_STATUS_OK) {
            memset(
                (vigil_interface_method_t *)memory + old_capacity,
                0,
                (next_capacity - old_capacity) * sizeof(*decl->methods)
            );
        }
...
vigil_status_t vigil_program_grow_constants(
    ...
    if (memory == NULL) {
        ...
        if (status == VIGIL_STATUS_OK) {
            memset(
                (vigil_global_constant_t *)memory + old_capacity,
                0,
...
vigil_status_t vigil_program_grow_globals(
    ...
    if (memory == NULL) {
        ...
        if (status == VIGIL_STATUS_OK) {
            memset(
                (vigil_global_variable_t *)memory + old_capacity,
                0,
...
vigil_status_t vigil_program_grow_functions(
    ...
    if (memory == NULL) {
        ...
        if (status == VIGIL_STATUS_OK) {
            memset(
                (vigil_function_decl_t *)memory + old_capacity,
                0,
